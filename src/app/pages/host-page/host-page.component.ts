...
import {HostPresentQuestionComponent,} from "../../host/host-present-question/host-present-question.component";
...
export class HostPageComponent {
  ...
  handleNextStepClick(): void {
    if (this.host.getCurrentStep()()!.hasNextStep()) return this.host.nextStep();
  ...
  get activeStepComponent(): Type<HostComponent> {
    if (this.host.getCurrentQuestion()() == undefined) return HostLoadingComponent;
